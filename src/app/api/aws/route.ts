...
export async function DELETE(req: NextRequest) { // Change from Response to NextRequest
    try {
...
export async function GET(req: NextRequest) {
    try {
        ...
        console.error(error);
        return new NextResponse("Error", { status: 500 }); // Changed to NextResponse for consistency
    }
}
